# Generated by Django 5.0.7 on 2024-08-18 06:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doc_format', models.CharField(choices=[('pdf', 'PDF'), ('docx', 'Word Document (.docx)'), ('xlsx', 'Spreadsheet'), ('ppt', 'Presentation'), ('vsd', 'Visio File'), ('mp3', 'Audio (.mp3)'), ('mp4', 'Video (.mp4)'), ('png', 'Image File'), ('txt', 'Text File'), ('other', 'Other')], default='docx', max_length=255)),
